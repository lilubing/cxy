package com.llb.cxy.infrastructure.constants;

/**
 * description: 用户常量定义类 <br>
 * date: 2020/7/29 8:40 <br>
...
public class UserConstants {
     ...
     * 手工输入用户默认密码
     */
    public static final String MANUAL_INPUT_USER_DEFAULT_PASSWORD = "qsc9099";

    /**
     * 性别
     */
    public static final int GENDER_MAN = 0;//男性
    public static final int GENDER_FEMALE = 1;//女性
    public static final int GENDER_SECRECY = 2;//保密
}
