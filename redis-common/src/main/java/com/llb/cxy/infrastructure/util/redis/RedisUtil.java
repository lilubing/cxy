package com.llb.cxy.infrastructure.util.redis;
...
/**
 * @author LiLuBing
 * @PackageName: com.llb.cxy.infrastructure.util.redis
 * @Description: Redis工具类
 * @ClassName: RedisUtil
 * @date 2021-01-21 上午8:19
 * @ProjectName cxy
 * @Version V1.0
 */
@Component
public class RedisUtil {
     ...
     * @return
     **/
    public void hPutAllMapValueList(String key, Map<String, Set<String>> maps) {
